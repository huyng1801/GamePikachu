...
public class MenuView extends JPanelBackground implements ActionListener{
    ...
    public void actionPerformed(ActionEvent e) {
        switch (e.getActionCommand()){
            case Utils.BT_EASY: if (onClickMenuListener!=null){
                onClickMenuListener.onNewGameClicked(TYPE_EASY);
            } break;
            case Utils.BT_MEDIUM: if (onClickMenuListener!=null){
                onClickMenuListener.onNewGameClicked(TYPE_MEDIUM);
            } break;
            case Utils.BT_HARD: if (onClickMenuListener!=null){
                onClickMenuListener.onNewGameClicked(TYPE_HARD);
            } break;
            case Utils.BT_SETTING: if (onClickMenuListener!=null){
                onClickMenuListener.onSettingClicked();
            } break;
            case Utils.BT_QUIT: if (onClickMenuListener!=null){
